...
public class EditClassTableAction extends BaseAction {
	...
	public String execute() 
	{
		...
		try 
		{	
			done = new ClassTableDAO().editClassTable(table_ID, term_ID, teacher_name, class_ID, classroom, course_name,
